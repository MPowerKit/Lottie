...
echo "sharpie bind"
sharpie bind --sdk=iphoneos17.5 --output="Output" --namespace="Com.Airbnb.Lottie" --scope="Output/LottieProxy-ios.xcframework/ios-arm64/LottieProxy.framework/Headers" "Output/LottieProxy-ios.xcframework/ios-arm64/LottieProxy.framework/Headers/LottieProxy-Swift.h"
